...
> **Projects are where I turn theory into working systems.**
...
### 🧠 [AI Quiz & Notes](https://github.com/aKmsdfhjb/Ai-quiz-and-notes)

AI-powered learning application for working with study material.
...
|  # | Area               | Focus                                      |
| -: | ------------------ | ------------------------------------------ |
|  1 | 🐍 Python          | Advanced Python & Software Engineering     |
|  2 | 🧠 Deep Learning   | Advanced Neural Networks & Architectures   |
|  3 | 🦙 LLM Engineering | RAG · Agents · MCP                         |
|  4 | 🎯 Fine-Tuning     | LoRA · PEFT · Multimodal Models            |
|  5 | ⚙️ MLOps           | Model Deployment · Evaluation · Monitoring |
|  6 | ☁️ Cloud           | AWS                                        |
